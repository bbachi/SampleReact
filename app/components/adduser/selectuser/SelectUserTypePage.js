...
import { CustomRadio,CustomRadioWithLink}  from '../../common/Radio';
...
class SelectUserTypePage extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            selection:{userType: "", subUserType:"", enableSubType:false,clickedUserType:""},
            isOpen: false,
            isError:false,
            formValidated:false
        }
    ...
    toggleModal(type){
      let selection = this.state.selection
      selection.clickedUserType=type;
    ...
    render(){
      ...
      let disabled = ''
      if(userType != '' && CommonUtil.isUserHasAssociations(userType)){
          disabled = 'disabled'
      }
      /*CODE TO REOMOVE LATER */
                ...
                <form name="selectUserFrm" id="selectUserFrm" method="post">
                    ...
                    <CustomButton buttonAttributes={ButtonAttributes}/>
                     <Modal show={forModal.isOpen} onClose={forModal.toggleModal}>
                        <UserTypeModal heading={this.state.selection.clickedUserType} onClose={forModal.toggleModal}/>
                    </Modal>
                </form>
            </div>
            </div>
