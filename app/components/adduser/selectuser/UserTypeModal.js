...
let UserTypeModal = (props) => {
    ...
    const userTypeContent = (heading) => {
              const AdminRoles = <ul>
                                    ...
                                    <li>Edit internal users' profile information through admin tool.</li>
                                    <li>Edit external users' profile information through admin tool.</li>
                                    <li>Reset users' password through admin tool.</li>
                ...
                const agentEMM = <ul>
          	       				...
          	       				<li>Access Admin Tool.</li>
          	       				<li>Edit external users' profile information through admin tool.</li>
          	       				<li>Change users' password through admin tool.</li>
